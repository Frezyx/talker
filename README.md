...
```yaml
dependencies:
  talker_dio_logger: ^5.0.0-dev.16
```
...
```yaml
dependencies:
  talker_bloc_logger: ^5.0.0-dev.16
```
...
```yaml
dependencies:
  talker_riverpod_logger: ^5.0.0-dev.16
```
...
```yaml
dependencies:
  talker_chopper_logger: ^5.0.0-dev.16
```
...
```yaml
dependencies:
  talker_grpc_logger: ^5.0.0-dev.16
```
