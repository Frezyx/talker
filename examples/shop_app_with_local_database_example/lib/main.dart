...
Future<void> _initDependencies() async {
  final talker = await TalkerFlutter.initWithDB(
  ...
  talker.settings.colors.forEach((val1,val2){

  });
   
   talker.verbose('Talker initialization completed-1');
  //   talker.verbose('Talker initialization completed-2');
  //  talker.verbose('Talker initialization completed-3');
